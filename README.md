<h1>Virtual Machine by Ruzal</h1>
<p>Этот проект был написан в рамках образовательного курса по системному программированию в МФТИ. В нем реализован свой Ассемблер и CPU.</p>


![image](https://github.com/SvetoCopy/CPU/assets/65361271/67d061ba-0592-46e4-bbfa-3c0bfecb8292)



<h2>Принцип работы Assembler</h2>
<p>На вход поступает код в файле expr.txt. Например, код функции вычисляющей дискриминант квадратного уравнения:</p>
...
DISCR:
    ...
    RET
```
<p>Полный список команд см. ниже.</p>
...
![image](https://github.com/SvetoCopy/CPU/assets/65361271/2f00967c-eb18-429c-8417-169586a0ec88)
...
<p>IMM - immediate value. REG - register.</p>

<h2>Пример:</h2>
<h3>Числo Фиббоначи</h3>
<p>Задача состоит в том, чтобы вывести n-ое число Фиббоначи. Входные данные: n. Реализовано с помощью рекурсии.</p>
